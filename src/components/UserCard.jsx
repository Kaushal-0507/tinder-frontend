...
const UserCard = ({ user }) => {
  ...
  return (
    <div className="w-full max-w-sm sm:max-w-md lg:w-88 h-[85vh] sm:h-[90vh] lg:max-h-[500px] lg:h-[95%] bg-gray-900 rounded-2xl overflow-hidden shadow-xl relative border border-gray-700 mx-auto lg:my-4 my-2">
      {/* User Photo */}
      ...
      <div className="absolute bottom-16 sm:bottom-20 left-4 sm:left-5 right-4 text-white">
        ...
        <p className="text-gray-300 text-xs sm:text-sm line-clamp-2 mb-0.5">{about}</p>
      ...
      <div className="absolute bottom-2 sm:bottom-4 left-0 right-0 flex justify-between items-center px-4 sm:px-6">
        ...
        >
          <svg className="w-6 sm:w-7 h-6 sm:h-7" fill="currentColor" viewBox="0 0 24 24">
